export const ICONS = {
  TOGGLE_ON: '<svg width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 8V12H7L11 16V4L7 8H3Z" fill="currentColor"/></svg>',
  TOGGLE_ON_ACTIVE: '<svg width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="10" cy="10" r="8" fill="#43a047"/><path d="M7 10.5L9 12.5L13 8.5" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  PLAY: '<svg width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><polygon points="6,4 16,10 6,16" fill="currentColor"/></svg>',
  PAUSE: '<svg width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="6" y="4" width="3" height="12" fill="currentColor"/><rect x="11" y="4" width="3" height="12" fill="currentColor"/></svg>',
  RESUME: '<svg width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><polygon points="6,4 16,10 6,16" fill="currentColor"/></svg>',
  STOP: '<svg width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="6" y="6" width="8" height="8" fill="currentColor"/></svg>',
